  ...
  <section class="campaign-page layout-campaign-page">
    <div class="campaign-page__inner inner">
      <ul class="campaign-page__tab tab common-fish">
        ...
        <li class="tab__item" data-number="tab02"><a href="<?php echo $campaign_license; ?>">ライセンス講習</a></li>
        <li class="tab__item" data-number="tab03"><a href="<?php echo $campaign_fandiving; ?>">ファンダイビング</a></li>
        <li class="tab__item is-active" data-number="tab04"><a href="<?php echo $campaign_experienced_diving; ?>">体験ダイビング</a></li>
      </ul> 
