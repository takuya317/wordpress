 ...
 <section class="voice-page layout-voice-page">
    ...
    <div class="voice-page__inner inner">  
      <ul class="voice-page__tab tab">
        ...
        <li class="tab__item<?php echo ($voice_term->name == 'ライセンス講習') ? ' is-active' : ''; ?>"><a href="<?php echo $voice_license; ?>">ライセンス講習</a></li>
        <li class="tab__item<?php echo ($voice_term->name == 'ファンダイビング') ? ' is-active' : ''; ?>"><a href="<?php echo $voice_fandiving; ?>">ファンダイビング</a></li>
        <li class="tab__item<?php echo ($voice_term->name == '体験ダイビング') ? ' is-active' : ''; ?>"><a href="<?php echo $voice_experienced_diving; ?>">体験ダイビング</a></li>
      </ul> 
